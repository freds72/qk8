...
function register_span(slice,x,y0,y1,id,w)
  for y=ceil(y0),ceil(y1) do
    local spans=slice[y]
    -- get latest span (if any)
    local span=spans[#spans]
    if span and span.id==id then
      span.x1=x
    else
      -- new or empty
      spans[#spans+1]={id=id,x0=x,x1=x,w=w}
    end
  end
end
      ...
      if root.dual then
        ...
        for x=cx,min(ceil(x1)-1,127) do
          ...
          if t>maxt then
            ...
            register_span(slices,x,maxt,t,id,w0)
          end
          -- floor
          if b<minb then
            --rectfill(x,minb,x,b,floor_c)
            register_span(slices,x,b,minb,id,w0)
...
function _draw()
  ...
  poke(0x5f38,2)
  poke(0x5f39,2)
  for _,slice in pairs(_spans) do
    for y,spans in pairs(slice) do
      for _,span in pairs(spans) do
        --rectfill(span.x0,y,span.x1,y,rnd())
        tline(span.x0,y,span.x1,y,0,y/8,span.w,0)
      end
    end
  end
...
__gfx__

__map__

